...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, dataset_path, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        """b
